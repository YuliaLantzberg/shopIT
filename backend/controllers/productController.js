...
// Get all products => /api/v1/products?keyword='smth'
...
exports.updateProduct = catchAsyncErrors(async (req, res) => {
  ...
  if (images !== undefined) {
    // Delete images assosiated with the product
...
// Get Product Reviews => /api/v1/reviews?id=123456
...
// Delete Product Reviews => /api/v1/reviews?productId=12323&reviewId=23546
